...
data.frame (AICc(B1,B2,B3,B4,B5,B6))
...
plot(Prop~StatWeek,data=Data2, subset=Size=="Low",  las=1, type="p", pch=16, cex=0.8,
     col=1,xlab="Statistical Week", ylab="Proportion", main="<=98,000 run size D106-41/42 fishery",
     font.lab=1, 
...
legend (34,0.7, legend=c("<=98,000", ">98,000"),
        cex=0.75,pch=16,col=c(1,2), bty="n", lwd=1)
